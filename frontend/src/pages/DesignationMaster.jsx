...
// You should ideally use a custom axios instance with withCredentials: true
// Example: import API from "../../../api";  (recommended)

export default function DesignationMaster({
  userRole,
  selectedCompanyId,
  selectedCompanyName,
  userId,           // ← Add this prop if possible (from parent or context)
}) {
  ...
  // Current user ID for createdBy/updatedBy in delete (fallback if not passed via props)
  const currentUserId = userId || "system"; // ← Replace with real value when you have auth context
