      ...
      include: [
        {
          ...
          as: 'employee',
          where: employeeWhere,
          attributes: ['staffId', 'staffNumber', 'firstName', 'lastName', 'uanNumber', 'dateOfJoining'],
          include: [
            {
              model: Department,
              as: 'department',
      ...
      include: [
        {
          ...
          as: 'employee',
          where: employeeWhere,
          attributes: ['staffId', 'staffNumber', 'firstName', 'lastName', 'esiNumber', 'dateOfJoining'],
          include: [
            {
              model: Department,
              as: 'department',
...
export const getTaxReport = async (req, res) => {
  try {
    ...
    const salaryData = await SalaryGeneration.findAll({
      ...
      include: [
        {
          ...
          as: 'employee',
          where: employeeWhere,
          attributes: ['staffId', 'staffNumber', 'firstName', 'lastName', 'panNumber', 'dateOfJoining'],
      ...
      order: [
        [{ model: Employee, as: 'employee' }, 'staffNumber', 'ASC'],
        ['salaryMonth', 'ASC']
      ]
    });
      ...
      include: [
        {
          ...
          as: 'employee',
          where: employeeWhere,
          attributes: ['staffId', 'staffNumber', 'firstName', 'lastName', 'state'],
          include: [
      ...
      include: [
        {
          ...
          as: 'employee',
          where: employeeWhere,
          attributes: ['staffId', 'staffNumber', 'firstName', 'lastName', 'dateOfJoining'],
          include: [
            { model: Department, as: 'department', attributes: ['departmentName'] },
            { model: Company, as: 'company', attributes: ['companyName'] }
          ]
...
export const downloadPFReportPDF = async (req, res) => {
  try {
    ...
    pfData.forEach((item, index) => {
      ...
      doc.text(item.employee.staffNumber, 80, yPos + 5, { width: 70, ellipsis: true });
